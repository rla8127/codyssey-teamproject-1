...
### 5.5 번외 (박세진님 JavaScript 코드)

본 프로젝트에 최종 적용된 것은 아니지만, 박세진님이 뉴스 선정을 JavaScript 코드로 개발한 것에 대해 매우 인상깊어서 해당 팀프로젝트 과제물에도 기재하였습니다.

> ![JavaScript 노드](images/04-javascript.png)
...
* Slack 알람 연동, Notion 데이터베이스 연동, 워크플로우에 대한 전반적인 플로우 모두 검토 및 개선 작업
* n8n 워크플로우 실제 구축 참여
